...
sections:
  - type: call-to-action.html
    ...
    title: <span style="color:#808080">Watershed Modeling</span>
    text:  <span style="color:#808080"<br>하이드로코어는 지난 20여 년의 시간동안 독자적으로 국내 유역환경 특성을 반영한 다수의 유역모델을 개발하여 왔습니다. 하이드로코어는 연구지역의 환경특성과 연구목적에 적합한 최적의 유역모델을 제공합니다. 이를 통해 환경 변화에 따른 미래의 수문, 수질 변동성을 예측하고 유역 특성에 따른 최적의 관리 방안을 과학적으로 제시하고 있습니다.</span>
    actions:
      - title: Get Started
        url: '#page-top'
        class: btn-success 
